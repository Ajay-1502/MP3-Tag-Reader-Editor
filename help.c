...
void no_arg()
{
    ...
    printf("===================================================================================\n");
    printf("Usage:\n");
    printf("To \"HELP\" please pass in this format: ./a.out --help\n");
    printf("To \"VIEW\" please pass in this format: ./a.out -v <file>\n");
    printf("To \"EDIT\" please pass in this format: ./a.out -e [-t/-a/-A/-y/-m/-c] \"<changing_txt>\" <file>\n");
